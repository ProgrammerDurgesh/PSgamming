                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="gameName" class="form-control" id="gameName" >
                                        ...
                                        <option value="bingoSlot">Bingo slot</option>
                                        <option value="shieldSlot">Shield Slot</option>
                                        <option value="fruitSlot">Fruit Slot</option>
                                        <option value="horseRaceSlot">Horse Race Slot</option>
